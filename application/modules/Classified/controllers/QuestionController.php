...
{
    // create question: proceed post query
    ...
    // update question: proceed post query
    public function updateAction()
    {
        ...
        // access
        if (is_null($question)) {throw new Zend_Exception("ERROR", 404);}
        $this->_helper->checkAdmin();
        ...
        try
        {
            ...
            // messages to session
            $session->write("messages_class", "success");
            $session->write("messages", "QUESTION_UPDATED_OK");
