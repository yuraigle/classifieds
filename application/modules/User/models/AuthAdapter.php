...
class User_Model_AuthAdapter implements Zend_Auth_Adapter_Interface
{
    ...
    protected function _authenticateSetup()
    {
        ...
        if ($this->_em === null) {
            ...
            $exception = 'A entity name must be supplied for the ZendX_Doctrine_Auth_Adapter authentication adapter.';
    ...
    // validate password (md5 with salt)
    protected function _validateCredential($identity)
    {
